...
namespace SqlSharpener
{
    ...
    public class DataTypeHelper
    {
        ...
        private void LoadDataTypes()
        {
            ...
            dataTypes.Add(DataTypes.@int, new Dictionary<TypeFormat, string> { { TypeFormat.SqlServerDbType, "int" }, { TypeFormat.DotNetFrameworkType, "int?" }, { TypeFormat.SqlDbTypeEnum, "Int" }, { TypeFormat.SqlDataReaderSqlType, "GetSqlInt32" }, { TypeFormat.DbTypeEnum, "Int32" }, { TypeFormat.SqlDataReaderDbType, "GetInt32" } });
